                        ...
                        <div class="col-12 col-lg-6 ">
                            ...
                            <div class="card-body  pb-0" style="border-radius: 20px;">
                                <div class="d-flex my-4 mx-auto d ">
                                    <label for="username" class=" mx-2 col-form-label"><img src="/proctoring/image/user.png" alt="" style="height:20px ;"></label>
                                    <input type="text" class="form-control  mx-auto mb-0 i" name="username" id="username" placeholder="username" style=" box-shadow: 2px 6px 18px rgba(66,57,238,0.3);" required>
                                </div>

                                <div class="d-flex my-4 mx-auto d ">
                                    <label for="password" class=" mx-2 col-form-label"><img src="/proctoring/image/password.png" alt="" style="height:20px ;"></label>
                                    <input type="password" class="form-control  mx-auto mb-0 i" name="password" id="password" placeholder="password" style=" box-shadow: 2px 6px 18px rgba(66,57,238,0.3);" required>
                                </div>



                                <div class="  text-center mx-auto my-5 mb-2 ">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="card card-body text-dark my-2" style="min-height:40vh;background:none;">
                            <form action="/proctoring/proctor/forgot_pass.php" method="get">
                                <div class="form-floating mb-2 text-center pb-0">

                                    <div class="row mb-3 ">
                                        <label for="ufno" class="col-sm-4 col-form-label">FAVOURATE-NUMBER</label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" name="ufno" id="ufno" placeholder="Favourite-Number" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="unick" id="unick" placeholder="Nickname" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="npassword" class="form-control" name="npassword" id="npassword" placeholder="New Password" required>
                                        </div>
                                    </div>
