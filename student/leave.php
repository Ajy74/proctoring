                    ...
                    <div class="card text-dark  mb-3">
                        <div class="card-body">
                            <form class="col-10 mx-auto text-center" action="/proctoring/imageUploder.php?by=<?php echo $username?>"
                                ...
                                <hr>
                                <input type="file" class="form-control my-5 p-2" name="afile" id="afile" style="width: 100%;border-radius: 15px;box-shadow: 2px 6px 18px rgba(66,57,238,0.2);" required>
