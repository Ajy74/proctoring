        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex ms-auto" role="search">
                    <input class="form-control me-2 my-3 my-lg-0 rounded" type="search" placeholder="Search"
                        aria-label="Search">
                    <button class="btn btn-outline-success my-3 my-lg-0 text-uppercase" type="submit">logout</button>
                </form>
            </div>
        </div>
    </nav>
